...
public class Gvar {
	...
	public static final int ONG_WIDTH = FEN_WIDTH - 7; //largeur du block onglet
	public static final int ONG_HEIGHT = FEN_HEIGHT - (ONG_HEADER_HEIGHT - MARGE); //hauteur du block onglet (28 : prend en compte l'intitule des onglets)
